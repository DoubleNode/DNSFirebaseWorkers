...
```swift
dependencies: [
.package(url: "https://github.com/DoubleNode/DNSFirebaseWorkers.git", from: "1.9.25")
]
```
...
-   FirebaseAnalytics v9.5.0+
-   FirebaseAuth v9.5.0+
-   FirebaseFirestore v9.5.0+
-   FirebaseMessaging v9.5.0+
-   FirebaseRemoteConfig v9.5.0+
