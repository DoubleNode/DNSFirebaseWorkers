...
open class WKRFirebaseAnalytics: WKRBlankAnalytics {
    ...
    public enum UserTraits {
        ...
        static let myPlace = "myPlace"
    }
    public enum Values {
        static let morning = "morning"
        static let afternoon = "afternoon"
        static let evening = "evening"
        static let lateNight = "late_night"
    }

    private enum Settings {
        enum AppInPlace {
            static let centerCode = "WKRFirebaseAnalytics_AppInPlace_placeCode"
            static let date = "WKRFirebaseAnalytics_AppInPlace_date"
            static let timeOfDay = "WKRFirebaseAnalytics_AppInPlace_timeOfDay"
        }
    }
